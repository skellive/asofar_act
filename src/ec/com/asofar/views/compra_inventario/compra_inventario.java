 ...
 */
package ec.com.asofar.views.compra_inventario;
 ...
 * @author admin
 */
public class compra_inventario extends javax.swing.JDialog {
    ...
    public compra_inventario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public compra_inventario(java.awt.Frame parent, boolean modal, PrProductos obj, SeUsuarios us, SeEmpresa em, SeSucursal su) {
        super(parent, modal);
...
//        String cadena = GenerarProductoNombre();
    ...
    private void initComponents() {
        ...
        txtEmpaqueVenta1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtEmpaqueVenta1ActionPerformed(evt);
            }
        });
        ...
        txtUVenta.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtUVentaActionPerformed(evt);
            }
        });
        ...
        jLabel23.setText("Precio Compra con iva:");
        ...
        jLabel27.setText("Precio Compra sin iva:");
        ...
        jLabel28.setText("Precio Venta P.V.P:");
        ...
        jTabbedPane8.addTab("Precio", jPanel3);
                    ...
                    if (Arrays.asList(cadenaArray1).contains(txtArticulo.getText())) {
                        ...
                        if (Arrays.asList(cadenaArray1).contains(txtPresentacionMedida.getText())) {
                            ...
                            if (Arrays.asList(cadenaArray1).contains(txtProducto.getText())) {
                                ...
                                if (presentacionMedida.getPrMedidasPK().equals(producto.getPrMedidas().getPrMedidasPK())) {
...
//                                                                    }
                                                                    ...
                                                                    if (bodegaNueva) {
                                                                        ...
                                                                        PrProductoBodega obj = new PrProductoBodega();
                                                                        obj.setStockMaximo(BigInteger.valueOf(Long.parseLong(txtStockMax.getText())));
                                                                        obj.setStockMinimo(BigInteger.valueOf(Long.parseLong(txtStockMin.getText())));
                                                                    ...
                                                                    Logger.getLogger(compra_inventario.class.getName()).log(Level.SEVERE, null, e);
                                                                }
                                                            }
                                                        }
                                                    }
    ...
    private void txtUVentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtUVentaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtUVentaActionPerformed

    private void txtEmpaqueVenta1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtEmpaqueVenta1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtEmpaqueVenta1ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(compra_inventario.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                compra_inventario dialog = new compra_inventario(new javax.swing.JFrame(), true);
