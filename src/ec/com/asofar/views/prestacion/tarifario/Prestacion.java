 ...
 */
public class Prestacion extends javax.swing.JDialog {
    ...
    public Prestacion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public Prestacion(java.awt.Frame parent, boolean modal, SeUsuarios us, SeEmpresa em, SeSucursal su) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        Tablas.listarTarifario(lista, tbltarifario);
    ...
    private void initComponents() {
        ...
        tbltarifario.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "TIPO DE PRESTACIONES", "PRODUCTO COMPRADO", "IVA", "FACTURABLE", "DESCUENTO"
            }
        ));
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ec/com/asofar/icon/Cancelar_Mesa de trabajo 1.jpg"))); // NOI18N
        jButton4.setText("GUARDAR TARIFARIO");
...
//        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Prestacion dialog = new Prestacion(new javax.swing.JFrame(), true);
