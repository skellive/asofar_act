...
import ec.com.asofar.views.DetallesTarifa.*;
 ...
 */
public class Tarifario extends javax.swing.JDialog {
    ...
    public Tarifario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public Tarifario(java.awt.Frame parent, boolean modal, PrTarifario tr, SeUsuarios us, SeEmpresa em, SeSucursal su) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NOMBRE DE PRESTACION", "UNIDAD DE SERVICIO", "VALOR DE COSTO", "%MINIMO DE VENTA", "VALOR DE VENTA", "%DESCUENTO"
            }
        ));
                        ...
                        if (list.get(i).getIdPrestacion() != null) {
                            ...
                            if (list.get(i).getIdPrestacion().intValue() == objpres.getInPrestacionesPorServiciosPK().getIdPrestacion()) {
                                ...
                                try {
                                    ...
                                    Logger.getLogger(Tarifario.class.getName()).log(Level.SEVERE, null, ex);
                                }
    ...
    private void txt_valor_min_porcentajeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_valor_min_porcentajeActionPerformed
        //porcentaje que se le aumentara al precio de compra para la venta al publico
    ...
    private void txt_porcentaje_descuentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_porcentaje_descuentoActionPerformed
        //porcentaje de descuento que se le restara al precio del valor de venta a publico
...
//        USER.setText(String.valueOf(tp.getUsuarioCreacion()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tarifario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Tarifario dialog = new Tarifario(new javax.swing.JFrame(), true);
