...
public class SeClientesJpaController implements Serializable {
    ...
    public void create(SeClientes seClientes) {
        ...
        try {
            ...
            SeTipoIdentificacion idTipoIndentificacion = seClientes.getIdTipoIndentificacion();
    ...
    public void edit(SeClientes seClientes) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (idTipoIndentificacionOld != null && !idTipoIndentificacionOld.equals(idTipoIndentificacionNew)) {
                idTipoIndentificacionOld.getSeClientesList().remove(seClientes);
                idTipoIndentificacionOld = em.merge(idTipoIndentificacionOld);
            }
